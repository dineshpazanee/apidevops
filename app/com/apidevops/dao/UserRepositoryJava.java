...
public class UserRepositoryJava {
    ...
    public UserRepositoryJava(Session session) {
    ...
    public void createUser(User user) {
        StringBuilder sb = new StringBuilder("INSERT INTO ").append(TABLE_NAME).append("(id, name, password, host) ").append("VALUES (").append(user.getId()).append(", '").append(user.getName()).append("', '").append(user.getPassword()).append("', '")
                .append(user.getHost()).append("');");
